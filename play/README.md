...
| featured_hypergraph_play.py         | [Exploring Hypergraph with TopoX Library](https://patricknicolas.substack.com/p/exploring-hypergraphs-with-topox)                                                                                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
...
| gnn_memory_monitor_play.py          | [Slimming the Graph Neural Network Footprint](https://patricknicolas.substack.com/p/slimming-the-graph-neural-network)                                                                                                                         |
...
| graph_attention_model_play.py       | [Graphs Deserve Some Attention](https://patricknicolas.substack.com/p/graphs-deserve-some-attention)                                                                                                                                           |
...
| neural_network_taichi_play.py       | [Turbocharging Neural Networks with Taichi Language](https://patricknicolas.substack.com/p/turbocharging-neural-networks-with)                                                                                                                 |
...
✅ featured_simplicial_complex_play.py    
...
✅ graph_attention_model_play.py
- Description and evaluation of Graph Attention Network using PyTorch Geometric
...
✅ neural_network_taichi_play.py 
- Introduction and evaluation of the Taichi Domain Specific Language for optimizing Numpy operations

✅ olliver_ricci_play.py
- Introduction to Discrete Differential Geometry and Olliver-Ricci curvature with Geomstats library
...
✅ topo_bench_play.py    
- Evaluation of TopoBench framework for the training of the lifting of a Hypergraph

✅ umap_play.py 
- Description, evaluation of UMAP dimension reduction technique and comparison with tSNE algorithm
