import unittest
import numpy as np
from topology.simplicial.simplicial_elements import SimplicialElements, SimplicialElement
...
class SimplicialElementsTest(unittest.TestCase):
    ...
    def test_simplicial_maps(self):
        ...
        simplicial_elements = SimplicialElements(simplicial_nodes, simplicial_edges, simplicial_faces)
        node_map = simplicial_elements.node_features_map()
        edge_map = simplicial_elements.edge_features_map()
        face_map = simplicial_elements.face_features_map()
        logging.info(f'\nNodes map:\n{node_map}\nEdges map:\n{edge_map}\nFaces map:\n{face_map}')
    ...
    def test_init_1(self):
        ...
        try:
            simplicial_feature_set = SimplicialElements.random(node_feature_dimension=4,
    ...
    def test_init_2(self):
        ...
        face_set = [[2, 3, 4], [1, 2, 3]]
        try:
            simplicial_feature_set = SimplicialElements.random(node_feature_dimension=3,
                                                               edge_node_indices=edge_set,
                                                               face_node_indices=face_set)
            logging.info(str(simplicial_feature_set))
        except AssertionError as e:
    ...
    def test_simplicial_up_laplacian_compute(self):
        ...
        try:
            simplicial_feature_set = SimplicialElements.random(node_feature_dimension=5,
                                                               edge_node_indices=edge_set,
                                                               face_node_indices=face_set)
    ...
    def test_incidence_undirected(self):
        ...
        face_set = [[2, 3, 4], [1, 2, 3]]
        try:
            simplicial_feature_set = SimplicialElements(features, edge_set, face_set)
            for rank in range(0, 3):
