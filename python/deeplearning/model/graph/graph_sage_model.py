...
class GraphSAGEModel(GraphBaseModel, Generic[SAGE]):

    def __init__(self,
                 model_id: AnyStr,
                 graph_SAGE_blocks: Tuple[GraphSAGEBlock[SAGE]],
...
class GraphSAGEBuilder(NeuralBuilder):
    ...
    def build(self) -> GraphSAGEModel:
        ...
        return GraphSAGEModel(self.model_attributes['model_id'], tuple(graph_SAGE_blocks), tuple(mlp_blocks))
