...
class Scatter2DGroup(VGroup):
    ...
    def __init__(self,
        ...
        #x_range, y_range = get_2d_ranges(data, num_lines)

        x_range, y_range = get_2d_ranges(list(zip(*data)), num_lines)
    ...
    def get_attributes(self) -> Write | Create:
...
class Scatter2DScene(Scene):
    ...
    def construct(self) -> None:
        ...
        scatter_2d_group = Scatter2DGroup(xy_labels=("x", "y"),
                                          ...
                                          all_points=Scatter2DScene.data_points).to_edge(LEFT)
        ...
        box = SurroundingRectangle(scatter_2d_group,
                                   ...
                                   fill_opacity=0.2,
                                   fill_color=BLACK)
        scatter = scatter_2d_group.get_attributes()
        self.add(box)
